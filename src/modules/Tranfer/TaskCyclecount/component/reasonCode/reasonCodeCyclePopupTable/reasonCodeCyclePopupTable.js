 ...
 (function() {
    'use strict'
    app.directive('reasonCodeCyclePopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/Tranfer/TaskCyclecount/component/reasonCode/reasonCodeCyclePopupTable/reasonCodeCyclePopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
