(function () {
    ...
    app.component('tranferFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, goodIssueFactory, localStorageService) {
            var $vm = this;
