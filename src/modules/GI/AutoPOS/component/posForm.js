(function () {
    ...
    app.component('autoPosForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/AutoPOS/component/posForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, autoPosFactory, callCenterItemFactory) {
            var $vm = this;
