'use strict'
app.component('autoPosTableList', {
    controllerAs: '$vm',
    templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
        return "modules/GI/AutoPOS/component/posTableList.html";
    },
    bindings: {
        isLoading: '=?',
        searchResultModel: '=?',
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, planGoodsIssueFactory, autoPosFactory, posFactory) {
        ...
        $scope.genQR = function (param) {
            $scope.popupReportQrCode.onClick(param);
        }

        $scope.popupReportQrCode = {
            onShow: false,
            delegates: {},
            onClick: function (param) {
                $scope.popupReport.onShow = !$scope.popupReport.onShow;
                $scope.popupReport.delegates.reportPopup(param, "generateQrcode");
            },
            config: {
                title: "ReportView"
            },
