(function () {
    ...
    app.component('posForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/POS/component/posForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, posFactory, callCenterItemFactory) {
            var $vm = this;
