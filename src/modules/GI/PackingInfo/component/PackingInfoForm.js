(function () {
    ...
    app.component('packingInfoForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/PackingInfo/component/PackingInfoForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, packingInfoFactory, callCenterItemFactory) {
            var $vm = this;
