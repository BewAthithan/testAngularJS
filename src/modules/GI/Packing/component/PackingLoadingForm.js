(function () {
    ...
    app.component('packingLoadingForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/Packing/component/PackingLoadingForm.html",
        bindings: {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, packingFactory, planGoodsIssueItemFactory) {
            var $vm = this;
