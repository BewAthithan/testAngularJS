(function () {
    ...
    app.component('pickingOrderPerformanceExpress', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/PickingOrderPerformanceExpress/pickingOrderPerformance.html",
        controller: function ($scope, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, $q, dpMessageBox, pickingOrderFactory) {
            ...
            $scope.search = function () {
                // pageLoading.show();
                service.pickingPerformanceExpressSearch($scope.filterModel).then(function (res) {
