    ...
    app.component('expected', {
        ...
        controller: function ($scope, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, $q, dpMessageBox,expectedFactory,loadTruckItemFactory,scanLoadToTruckFactory) {
            ...
            $scope.ScanCarton = function () {
                ...
                $vm.filterModel.userName = $scope.userName;
            ...
            $("#tagOutNo").bind("focus", function () {
                setTimeout(() => {
                    $("#tagOutNo").removeAttr("readonly");
                }, 200);
            }).bind("blur", function () {
                $("#tagOutNo").attr("readonly", "readonly");
            ...
            $scope.getColor = function (param) {
                if (param.isCancel == 1) {
                    return "background:rgb(255, 36, 0);color:rgb(255, 255, 255)";
                    //return "color:rgb(255, 0, 255)";
                }
                else if (param.isCartonEmpty == 1) {
