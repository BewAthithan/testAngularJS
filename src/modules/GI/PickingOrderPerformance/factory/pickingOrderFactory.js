    ...
    app.factory("pickingOrderFactory",
        function ($q, $http, ngAuthSettings, localStorageService,  webServiceAPI, clientService) {
            ...
            return {
                ...
                pickingPerformanceClickandCollectSearch: function (model) {
                    var urlRequest = this.url + "/PickingPerformanceClickandCollectSearch";
                    return clientService.post(urlRequest, model);
                },
                pickingPerformanceBacklogSearch: function (model) {
                    var urlRequest = this.url + "/pickingPerformanceBacklogSearch";
                    return clientService.post(urlRequest, model);
                },
            }
        });
