(function () {
    'use strict';
    app.component('packConfirmPWBFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/GI/packConfirmPWB/component/packConfirmPWBFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, packConfirmPWBFactory, dpMessageBox) {
            var $vm = this;
