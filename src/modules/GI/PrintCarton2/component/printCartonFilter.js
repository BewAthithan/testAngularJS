(function () {
    'use strict';
    app.component('printCartonFilterTwo', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/GI/PrintCarton2/component/printCartonFilter.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, printCartonFactoryTwo,dpMessageBox, localStorageService) {
            var $vm = this;
