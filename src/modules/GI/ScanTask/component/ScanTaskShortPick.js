(function () {
    'use strict'
    app.component('scanTaskShortPick', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/GI/ScanTask/component/ScanTaskShortPick.html";
        },
        bindings: {
            searchResultModel: '=?',
            filterModel: '=?',
        ...
        controller: function ($scope, $filter, $q, $compile, $http, $state, pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, reasonCodeMasterFactory, scanTaskFactory) {
            var $vm = this;
            $scope.items = [];
            ...
            $scope.Confirm = function () {
                let _viewModel = scanTaskFactory;                
                $scope.validateMsg = "";
                validate().then(function (result) {
                    if (result) {
                        ...
                        _viewModel.CartDataScanConfirm($scope.filterModel).then(function success(res) {
                            pageLoading.hide();
                            ...
                            defer.resolve(res.data.msgResult);
