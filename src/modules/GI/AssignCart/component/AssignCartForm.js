(function () {
    ...
    app.component('assignCartForm', {
        controllerAs: '$vm',
        templateUrl: "modules/GI/AssignCart/component/AssignCartForm.html",
        bindings: {
            isLoading: '=?',
            onShow: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, assignCartFactory) {
            var $vm = this;
