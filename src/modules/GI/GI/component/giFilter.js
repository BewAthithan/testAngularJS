(function () {
    ...
    app.component('giFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading,dpMessageBox, commonService, goodIssueFactory, localStorageService) {
            var $vm = this;
