...
(function () {
    'use strict'
    app.directive('checkCartonPopupV2', ['ngAuthSettings', '$window', 'commonService', 'pageLoading', '$timeout',
        function (ngAuthSettings, $window, commonService, pageLoading, $timeout) {
            return {
                restrict: 'E',
                controllerAs: '$ctrl',
                templateUrl: "modules/GI/CartNumberV2/component/CheckCartonNumberV2/checkCartonPopupV2.html",
                scope: {
                    onShow: '=',
                    delegates: '=?',
                    invokes: '=?',
