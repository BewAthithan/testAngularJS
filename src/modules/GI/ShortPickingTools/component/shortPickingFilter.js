(function () {
    'use strict';
    app.component('shortPickingFilter', {
        controllerAs: '$vm',
        templateUrl: function ($element, $attrs, /*ngAuthSettings,*/ $window, commonService) {
            return "modules/GI/ShortPickingTools/component/shortPickingFilter.html";
        },
        bindings: {
            isLoading: '=?',
            searchResultModel: '=?',
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService, shortPickingFactory, localStorageService) {
            var $vm = this;
