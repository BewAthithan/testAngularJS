(function () {
    ...
    app.component('locationWorkAreaFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationWorkAreaFactory) {
            var $vm = this;
            ...
            $scope.searchFilter = function (item) {    
                ...
                if(item.locationWorkAreaId == "" || item.locationName == "" || item.workAreaName == ""){
                    item = $scope.model;
                }
