 ...
 (function() {
    'use strict'
    app.directive('zonePutAwayPopupTable', function() {
        return {
            restrict: 'E',
            controllerAs: '$ctrl',
            templateUrl: "modules/masterData/component/zonePutAwayPopup/zonePutAwayPopupTable/zonePutAwayPopupTable.html",
            scope: {
                delegates: '=',
                invokes: '=',
                config: '=',
            ...
            controller: ['$scope', 'commonService', '$filter', function($scope, commonService, $filter) {
                ...
                $scope.model = {
                    ...
                    numPerPage: $scope.config.currentPage,
                    totalItem: 0
                };
                $scope.show = {
                    action: true,
                    ...
                    change: function() {
                        if ($scope.invokes.page) {
                            var p = {
                                ...
                                numPerPage: $scope.pagging.currentPage
                            };
                            var all = {
                                currentPage: 0,
                                numPerPage: 0
