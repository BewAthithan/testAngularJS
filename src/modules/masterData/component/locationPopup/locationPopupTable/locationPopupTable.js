            ...
            controller: ['$scope', 'commonService', '$filter', function($scope, commonService, $filter) {
                ...
                $scope.delegate = {
                    set: function(model, paginations) {
                        $scope.items = model;
                        $scope.pagging.totalRow = paginations.totalItem;
                        $scope.pagging.currentPage = paginations.currentPage;
                        $scope.pagging.num = paginations.totalPage;
                    },
