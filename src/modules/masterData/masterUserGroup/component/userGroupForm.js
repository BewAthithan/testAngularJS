(function () {
    ...
    app.component('userGroupForm', {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, userGroupFactory) {
            var $vm = this;
            ...
            $vm.onShow = function (param) {
                ...
                if (param != undefined) {
                    pageLoading.show();
                    $scope.create = false;
                    viewModel.getId(param.userGroupIndex).then(function (res) {
                        pageLoading.hide();
            ...
            function validate(param) {
                ...
                if (param.userGroupName == undefined) {
                    msg = ' UserGroup Name is required !'
                    defer.resolve(msg);
                }
