(function () {
    ...
    app.component('workAreaForm', {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,workAreaFactory) {
            var $vm = this;
            ...
            function validate(param) {
                let defer = $q.defer();
                let msg = "";
                if (param.workAreaName == undefined) {
                    msg = ' WorkArea Name is required !'
                    defer.resolve(msg);
                } 
                defer.resolve(msg);
