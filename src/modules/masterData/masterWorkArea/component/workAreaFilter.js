(function () {
    ...
    app.component('workAreaFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,workAreaFactory) {
            var $vm = this;
            ...
            $scope.searchFilter = function (item) {                
                ...
                if(item.workAreaId == "" || item.workAreaName == "" ){
                    item = $scope.model;
                }
