(function () {
    ...
    app.component('masterEquipmentSubtypeFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,equipmentSubTypeFactory) {
            var $vm = this;
            ...
            $scope.searchFilter = function (item) {
                ...
                if(item.equipmentSubTypeId == "" || item.equipmentSubTypeName == "" || item.equipmentTypeName == ""){
                    item = $scope.model;
                }
