...
app.component('userGroupMenuTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, localStorageService, dpMessageBox,userGroupMenuFactory) {
        var $vm = this;
        ...
        $scope.delete = function (param) {
            dpMessageBox.confirm({
                ...
                viewModel.getDelete(param.userGroupMenuIndex).then(function success(res) {
                    $vm.triggerSearch();
                }, function error(res) { });
            });
        };
