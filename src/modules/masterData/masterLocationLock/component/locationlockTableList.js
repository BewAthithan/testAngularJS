...
app.component('locationlockTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,locationLockFactory) {
        var $vm = this;
        ...
        $scope.delete = function (param) {                       
            dpMessageBox.confirm({
                ...
                viewModel.getDelete(param.locationAisleIndex).then(function success(res) {
                    $vm.triggerSearch();
                }, function error(res) { });
            });
        };
