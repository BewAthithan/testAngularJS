(function () {
    ...
    app.component('locationlockFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,locationLockFactory) {
            var $vm = this;
            ...
            $scope.searchFilter = function (item) {    
                ...
                if(item.locationLockId == "" || item.locationLockName == "" ){
                    item = $scope.model;
                }
