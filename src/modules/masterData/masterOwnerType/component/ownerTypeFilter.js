(function () {
    ...
    app.component('ownerTypeFilter', {
        ...
        controller: function ($scope, $q, $http, $filter, $state, $window, $element, $timeout, $translate, /*ngAuthSettings,*/ pageLoading, commonService,ownerTypeFactory) {
            var $vm = this;
            ...
            $scope.searchFilter = function (item) {                
                ...
                if(item.ownerTypeId == "" || item.ownerTypeName == "" ){
                    item = $scope.model;
                }
