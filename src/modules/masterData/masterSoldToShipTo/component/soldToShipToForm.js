(function () {
    ...
    app.component('soldToShipToForm', {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, soldToShipToFactory) {
            var $vm = this;
            ...
            $vm.onShow = function (param) {
                ...
                if (param != undefined) {
                    pageLoading.show();
                    $scope.create = false;   
                    viewModel.getId(param.soldToShipToIndex).then(function (res) {
                        pageLoading.hide();
            ...
            $scope.popupShipTo = {
                ...
                invokes: {
                    ...
                    selected: function (param) {
                        ...
                        $scope.filterModel.shipToName = angular.copy(param.shipToId) + " - " + angular.copy(param.shipToName);
