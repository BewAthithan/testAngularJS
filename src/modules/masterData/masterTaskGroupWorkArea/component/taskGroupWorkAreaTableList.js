...
app.component('taskGroupWorkAreaTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,taskGroupWorkAreaFactory) {
        var $vm = this;
        ...
        $scope.delete = function (param) {
            dpMessageBox.confirm({
                ...
                viewModel.getDelete(param.taskGroupWorkAreaIndex).then(function success(res) {
                    $vm.triggerSearch();
                }, function error(res) { });
            });
        };
