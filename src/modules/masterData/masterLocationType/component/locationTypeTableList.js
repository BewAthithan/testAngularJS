...
app.component('locationTypeTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox,locationTypeFactory) {
        var $vm = this;
        ...
        $scope.delete = function (param) {            
            dpMessageBox.confirm({
                ...
                viewModel.getDelete(param.locationTypeIndex).then(function success(res) {
                    $vm.triggerSearch();
                }, function error(res) { });
            });
        };
