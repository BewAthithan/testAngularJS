(function () {
    ...
    app.component('locationTypeForm', {
        ...
        controller: function ($scope, $q, $filter, $http, /*ngAuthSettings,*/ $state, /*authService*/ pageLoading, $window, commonService, localStorageService, $timeout, $translate, dpMessageBox, locationTypeFactory) {
            var $vm = this;
            ...
            $vm.onShow = function (param) {
                ...
                if (param != undefined) {
                    pageLoading.show();
                    $scope.create = false;
                    viewModel.getId(param.locationTypeIndex).then(function (res) {
                        pageLoading.hide();
            ...
            function validate(param) {
                let defer = $q.defer();
                let msg = "";
                if (param.locationTypeName == undefined) {
                    msg = ' LocationType Name is required !'
                    defer.resolve(msg);
                }
