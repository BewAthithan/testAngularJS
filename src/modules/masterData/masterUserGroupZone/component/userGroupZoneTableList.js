...
app.component('userGroupZoneTableList', {
    ...
    controller: function ($scope, $filter, $q, $compile, $http, /*ngAuthSettings,*/ $state, /*authService,*/ pageLoading, $window, localStorageService, dpMessageBox,userGroupZoneFactory) {
        var $vm = this;
        ...
        $scope.delete = function (param) {
            dpMessageBox.confirm({
                ...
                viewModel.getDelete(param.userGroupZoneIndex).then(function success(res) {
                    $vm.triggerSearch();
                }, function error(res) { });
            });
        };
